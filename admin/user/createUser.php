...
try{
    ...
    $stmt1 = $dbh->prepare("INSERT INTO `user`(`firstname`, `lastname`, `email`, `password`, `phone_number`, `cv`, `role`) 
    VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    $stmt2 = $dbh->prepare("INSERT INTO `address`(`street_number`, `street_name`, `additional`, `zip`, `city`, `radius`, `sector`,`user`) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
